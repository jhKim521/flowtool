...
> **STEP 8 완료 / STEP 9 진행 예정**

현재 목표

> **기존 Capture 조회 기능을 Query 전용 API로 분리한다.**
...
STEP 9가 완료되기 전까지는 다른 기능을 구현하지 않는다.

Proxy 전달 기능은 STEP 10에서 구현한다.

현재 단계에서는 기존 Capture 조회 기능을 Query 전용 API로 분리하는 데만 집중한다.
